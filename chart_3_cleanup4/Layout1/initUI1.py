...
from c__init__ import para,nb,sval,sto1,plr,start,com1,com2,com3
pic=[]
...
def initUI(self):
  ...
  for i,con1 in enumerate((self.c0,self.c1,self.c2)): btn(self,self.tab0,con1,i)
  ...
  for i,con1 in enumerate((self.c3,self.c4)): i+=3;btn(self,self.tab1,con1,i)
    
  # data 
  self.df='';self.sto2=[]  
  self.para,self.nb,self.sval,self.sto1,self.plr,self.start,self.com1,self.com3=para,nb,sval,sto1,plr,start,com1,com3  